...
class checkout(View):
    def get(self,request):
        ...
        #{'id': 'order_KwbgzeM7NXWRIj', 'entity': 'order', 'amount': 7200, 'amount_paid': 0, 'amount_due': 7200, 'currency': 'INR', 'receipt': 'order_rcptid_12', 'offer_id': None, 'status': 'created', 'attempts': 0, 'notes': [], 'created_at': 1672072598} 
